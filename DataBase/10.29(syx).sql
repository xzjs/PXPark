...
insert  into `px_car`(`id`,`no`,`type`,`color`,`brand_id`,`model_id`) values (1,'鲁B123','1',NULL,NULL,NULL),(2,'鲁8y63','2',NULL,NULL,NULL);
...
CREATE TABLE `px_pricay` (
  ...
  `content` text COMMENT '条款文档',
  `time` datetime DEFAULT NULL,
  `url` char(80) DEFAULT NULL COMMENT 'url',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;

/*Data for the table `px_pricay` */

insert  into `px_pricay`(`id`,`content`,`time`,`url`) values (1,NULL,'2015-10-20 14:50:09','http://localhost/PXPark/index.php/Home/Privacy/detail/id/1'),(2,NULL,'2015-11-20 14:50:09','http://localhost/PXPark/index.php/Home/Privacy/detail/id/2'),(3,NULL,'2015-01-20 14:50:09','http://localhost/PXPark/index.php/Home/Privacy/detail/id/3');
...
/*Data for the table `px_rechangerecord` */
