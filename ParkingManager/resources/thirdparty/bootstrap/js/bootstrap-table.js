...
!function ($) {
    ...
    var BootstrapTable = function (el, options) {
        ...
        this.options.tableId = el.id;//add by xwj for queryParams 2015/05/06
        this.timeoutId_ = 0;
    ...
    BootstrapTable.prototype.initHeader = function () {
        ...
        $.each(this.options.columns, function (i, column) {
            ...
            that.header.formatterParams.push(column.formatterParam);
    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        if(this.options.showPaginationLeft){
        	 html.push(
        ...
        html.push('<div class="pull-' + this.options.paginationHAlign + '">',
    ...
    //add by xwj for going to the first page.2015-5-15
    BootstrapTable.prototype.showFirstPage = function () {
        this.onPageFirst();
    };
    ...
    BootstrapTable.prototype.initBody = function (fixedScroll) {
        ...
        for (var i = this.pageFrom - 1; i < this.pageTo; i++) {
            ...
            $.each(this.header.fields, function (j, field) {
                ...
                value = calculateObjectValue(that.header,
                    that.header.formatters[j], [value, item, i, that.header.formatterParams[j]], value);
                ...
                cellStyle = calculateObjectValue(that.header,
                    that.header.cellStyles[j], [value, item, i, that.header.formatterParams[j]], cellStyle);
        ...
        this.$body.find('> tr > td').off('click').on('click', function () {
            ...
            //add by xwj for change row's background color on click.2015-5-15
            $tr.siblings('tr').not($tr).removeClass('selected');
...
//        });
    ...
    //add by xwj for select a row.2015-5-15
    BootstrapTable.prototype.selectRow = function (index) {
    	var tr = this.$body.find('tr').eq(index);
    	tr.siblings('tr').not(tr).removeClass('selected');
    	tr.addClass('selected');
        
        this.trigger('click-row', this.data[index], tr);
    };
    ...
    BootstrapTable.prototype.checkBy_ = function (checked, obj) {
        ...
        $.each(this.options.data, function (index, row) {
            ...
            if ($.inArray(row[obj.field].toString(), obj.values) !== -1) {
