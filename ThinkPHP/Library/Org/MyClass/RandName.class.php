...
class RandName {
	...
	private function getNickList() {
		...
		$this->numbNick = count ( $this->arrNick ); // 姓总数
	}
	...
	private function getNick() {
		return $this->arrNick [mt_rand ( 0, $this->numbNick )];
	}
	
	public  function getNickname(){
		return $this->getNick ().$this->getNick ().$this->getNick ().$this->getNick ().$this->getNick ().$this->getNick ();
	}
